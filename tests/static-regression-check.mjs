...
const requiredOrders = new Map([
  ...
  [".dashboard .dashboard-task-panel", "9"],
  [".dashboard .schedule-panel", "8"],
  [".dashboard > .panel:has(#dailyTasks)", "10"],
  [".dashboard > .metrics-panel:has(#mailMorningChecked)", "10"],
  [".dashboard > .metrics-panel:has(#dmPending)", "11"],
