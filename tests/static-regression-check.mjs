...
const requiredIds = [
  ...
  "saveSubstack",
  "substackStatus",
  "substackArticleTitle",
  "substackArticlePublished",
  "substackQuoteRestacks",
  "substackNewSubscribers",
  "substackTotalFollowers",
  "substackDidArticle",
  "substackDidNotes",
  "substackDidComments",
  "substackDidMorningStack",
  "substackDidLive",
  "substackInsight",
  "substackTodayArticleTheme",
  "substackTodayTasks",
  "substackTodayExperiment",
  "substackStockArticleIdeas",
  "substackStockNotesIdeas",
  "substackStockSeed",
  "noteAiPage",
  "saveNoteAi",
  "noteAiStatus",
  "noteAiArticleTitle",
  "noteAiArticlePublished",
  "noteAiViews",
  "noteAiLikes",
  "noteAiInsight",
  "noteAiTodayArticleTheme",
  "noteAiTodayTasks",
  "noteAiStockArticleIdeas",
  "noteAiSeoQueue",
  "noteBeginnerPage",
  "saveNoteBeginner",
  "noteBeginnerStatus",
  "noteBeginnerArticleTitle",
  "noteBeginnerArticlePublished",
  "noteBeginnerViews",
  "noteBeginnerLikes",
  "noteBeginnerInsight",
  "noteBeginnerTodayArticleTheme",
  "noteBeginnerTodayTasks",
  "noteBeginnerStockArticleIdeas",
  "noteBeginnerCommonQuestions",
  "xPageV1",
  "saveXPageV1",
  "xPageV1Status",
  "xPageYesterdayPost1",
  "xPageYesterdayPost2",
  "xPageYesterdayPost3",
  "xPagePost1Impressions",
  "xPagePost1Likes",
  "xPagePost1Engagements",
  "xPagePost1DetailClicks",
  "xPagePost1ProfileAccesses",
  "xPagePost2Impressions",
  "xPagePost2Likes",
  "xPagePost2Engagements",
  "xPagePost2DetailClicks",
  "xPagePost2ProfileAccesses",
  "xPagePost3Impressions",
  "xPagePost3Likes",
  "xPagePost3Engagements",
  "xPagePost3DetailClicks",
  "xPagePost3ProfileAccesses",
  "xPageFollowers",
  "xPageInsight",
  "xPageTodayPost1",
  "xPageTodayPost2",
  ...
  "wordpressArticleTitle",
  "wordpressArticlePublished",
  "wordpressInsight",
  "wordpressTodayNewArticle",
  "wordpressTodayWritingArticle",
  "wordpressTodayFixedPage",
  "wordpressTodayPageProgress",
  "wordpressTodayTasks",
  "wordpressStockNewArticle",
  "wordpressStockArticleIdeas",
  "wordpressStockFixedPage",
  "wordpressStockImprovementIdeas",
  "dashboard-input",
  ...
  "dailyInputText",
  "activityStartSubstackRegular",
  "activityStartSubstackAbuse",
  "activityStartSubstackBeginner",
  "activityStartNoteRegular",
  "activityStartNoteSubstackBeginner",
  "activityEndSubstackRegular",
  "activityEndSubstackAbuse",
  "activityEndSubstackBeginner",
  "activityEndNoteRegular",
  "activityEndNoteSubstackBeginner",
  "todayTaskDateLabel",
  "todayEventDateLabel",
  "dailyTasks",
...
const requiredOrders = new Map([
  ...
  [".dashboard .sleep-summary-panel", "8"],
  [".dashboard .capacity-check-section", "12"],
  ...
  [".dashboard .learning-asset-panel", "23"],
  [".dashboard .reading-notes-panel", "66"],
...
const learningAssetTokens = [
  ...
  "learningAssetArticleCount",
  "learningAssetDoneCount",
  "learningAssetPublishedTo",
  "learningAssetConnectsTo",
];
for (const token of learningAssetTokens) {
...
check(appJs.includes("learningAssets: learningAssetItems"), "学び資産化データがスナップショットに入りません");
check(stylesCss.includes(".learning-asset-flow-map"), "学び資産化の進行ボードCSSがありません");
check(mobileCss.includes(".learning-asset-form"), "モバイル規則に学び資産化フォームがありません");
