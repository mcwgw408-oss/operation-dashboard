...
const requiredOrders = new Map([
  ...
  [".dashboard .capacity-check-section", "9"],
  [".dashboard .after-ten-mode-panel", "10"],
  [".dashboard .dashboard-task-panel", "11"],
  [".dashboard .schedule-panel", "12"],
  [".dashboard > .panel:has(#dailyTasks)", "13"],
  [".dashboard > .metrics-panel:has(#mailMorningChecked)", "14"],
  [".dashboard > .metrics-panel:has(#dmPending)", "15"],
